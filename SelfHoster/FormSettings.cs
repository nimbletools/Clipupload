...
namespace SelfHoster
{
  ...
  {
    SelfHoster mainClass;

    public FormSettings(SelfHoster mainClass)
    {
      InitializeComponent();

      this.mainClass = mainClass;

      textInterface.Text = this.mainClass.host_interface;
      numPort.Value = mainClass.host_port;
      textHTTP.Text = this.mainClass.web_http;
      checkAccessLog.Checked = this.mainClass.web_accesslog;
      checkHostNotify.Checked = this.mainClass.web_accessNotify;
      checkHostDelete.Checked = this.mainClass.web_accessDelete;
    ...
    {
      mainClass.settings.SetString("HostInterface", textInterface.Text);
      mainClass.settings.SetInt("HostPort", (int)numPort.Value);
      mainClass.settings.SetString("HostHTTP", textHTTP.Text);
      mainClass.settings.SetBool("HostAccessLog", checkAccessLog.Checked);
      mainClass.settings.SetBool("HostNotify", checkHostNotify.Checked);
      mainClass.settings.SetBool("HostDelete", checkHostDelete.Checked);
