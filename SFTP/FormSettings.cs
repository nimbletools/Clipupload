...
namespace SFTP
{
  public partial class FormSettings : Form
  {
    ...
    public FormSettings(SFTP mainClass)
    {
      InitializeComponent();

      this.mainClass = mainClass;

      textServer.Text = mainClass.sshServer;
      numPort.Value = mainClass.sshPort;
      textUsername.Text = mainClass.sshUsername;
      textPassword.Text = mainClass.sshPassword;
      textPath.Text = mainClass.sshPath;
      textHttp.Text = mainClass.sshHttp;
    ...
    private void button1_Click(object sender, EventArgs e)
    {
      ...
      mainClass.settings.SetInt("Port", (int)numPort.Value);
