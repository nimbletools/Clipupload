...
namespace Imgur
{
  ...
  public class JSON
  {
    ...
    internal static Hashtable ParseObject(char[] json, ref int index, ref bool success)
    {
    ...
    internal static ArrayList ParseArray(char[] json, ref int index, ref bool success)
    {
    ...
    internal static double ParseNumber(char[] json, ref int index)
    {
      EatWhitespace(json, ref index);
    ...
    internal static void EatWhitespace(char[] json, ref int index)
    {
    ...
    internal static int LookAhead(char[] json, int index)
    {
      int saveIndex = index;
      return NextToken(json, ref saveIndex);
    }

    internal static int NextToken(char[] json, ref int index)
    {
      EatWhitespace(json, ref index);
