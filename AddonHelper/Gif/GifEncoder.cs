...
namespace Gif.Components {
    public class AnimatedGifEncoder {
        ...
        protected void GetImagePixels() {
            ...
            BitmapData bmpData = tempBitmap.LockBits(new Rectangle(0, 0, image.Width, image.Height), ImageLockMode.ReadOnly, PixelFormat.Format24bppRgb);
            pixels = new byte[Math.Abs(bmpData.Stride) * image.Height];
